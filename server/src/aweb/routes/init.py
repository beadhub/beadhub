...
from aweb.bootstrap import AliasExhaustedError, BootstrapIdentityResult, bootstrap_identity, ensure_project
...
async def init(
    ...
    """Bootstrap identity and optionally register an aweb workspace.

    - Always mints a new `aw_sk_*` API key for the created/ensured agent.
    - If `repo_origin` is provided, also ensures the repo and creates an aweb workspace
