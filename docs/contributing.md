...
1. Add or update the route module under:
   - [`server/src/aweb/routes/`](/Users/juanre/prj/awebai/aweb-frank/server/src/aweb/routes)
   - or [`server/src/aweb/coordination/routes/`](/Users/juanre/prj/awebai/aweb-frank/server/src/aweb/coordination/routes)
...
4. Add route-level tests under
   [`server/tests/`](/Users/juanre/prj/awebai/aweb-frank/server/tests).
...
7. Update the docs under [`docs/`](/Users/juanre/prj/awebai/aweb-frank/docs).
...
4. Document the tool in [`docs/mcp-tools-reference.md`](/Users/juanre/prj/awebai/aweb-frank/docs/mcp-tools-reference.md).

## How to Add a CLI Command

1. Add or update a Cobra command under
   [`cli/go/cmd/aw/`](/Users/juanre/prj/awebai/aweb-frank/cli/go/cmd/aw).
...
4. Verify help output stays clear, because the docs are generated from the live
   command surface.
5. Update [`docs/cli-command-reference.md`](/Users/juanre/prj/awebai/aweb-frank/docs/cli-command-reference.md).

## Migrations

- Server schema migrations live under:
  - [`server/src/aweb/migrations/server/`](/Users/juanre/prj/awebai/aweb-frank/server/src/aweb/migrations/server)
  - [`server/src/aweb/migrations/aweb/`](/Users/juanre/prj/awebai/aweb-frank/server/src/aweb/migrations/aweb)
